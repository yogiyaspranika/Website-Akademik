...
<div class="side-bar">
    <h3>List Materi</h3>
    <div class="colr1">
                <a href=""><img src="img/icon/animasi.gif" heigth="60px" width="100px"></a>
            <br>
            <?php $i = 1;?>
            <?php foreach($tampilFile as $tampil1): ?>
                - <a href="?module=file&files=<?php echo $tampil1['namaData']; ?>&judul=<?php echo $tampil1['judul']; ?>" target="_blank">
